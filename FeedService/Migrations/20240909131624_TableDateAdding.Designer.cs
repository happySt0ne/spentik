...
namespace FeedService.Migrations
{
    ...
    [Migration("20240909131624_TableDateAdding")]
    partial class TableDateAdding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FeedService.DataLayer.DataModels.Table", b =>
                {
                    b.HasOne("FeedService.DataLayer.DataModels.Column", "Column")
                        .WithOne("Table")
                        .HasForeignKey("FeedService.DataLayer.DataModels.Table", "ColumnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FeedService.DataLayer.DataModels.Item", "Item")
                        .WithOne("Table")
                        .HasForeignKey("FeedService.DataLayer.DataModels.Table", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
